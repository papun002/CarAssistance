            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left">
                        ...
                        <h1 class="page-title">OnRoad Vechile Breakdown Assistance (USER)</h1>                        
                    </div>
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    <a class="dropdown-item" href="user-profile.php"><i class="dropdown-icon fa fa-user"></i> Profile</a>
                                    <a class="dropdown-item" href="user-profile.php"><i class="dropdown-icon fe fe-settings"></i> Settings</a>
                                    <a class="dropdown-item" href="javascript:void(0)"><span class="float-right"><span class="badge badge-primary">6</span></span><i class="dropdown-icon fe fe-mail"></i> Inbox</a>
                                    <a class="dropdown-item" href="javascript:void(0)"><i class="dropdown-icon fa fa-send"></i> Message</a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="../login/loginpage.php"><i class="dropdown-icon fa fa-log-out"></i> Sign out</a>
                                </div>
                            </div>
                        </div>
                    </div>
