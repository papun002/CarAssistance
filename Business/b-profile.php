                    ...
                    <div class="row mt-3">
                        <div class="col-xl-4">
                            ...
                            <div class="card mb-4 mb-xl-0">
                                <div class="card-header">Business Picture</div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <div class="col-md-12">
                                                <label class="small mb-1" for="inputPhone">Organization Name</label>
                                                <input class="form-control" id="inputPhone" type="text"
                                                    placeholder="Enter your phone number"
                                                    value="OnRoad Vehicle Breakdown Assistance" disabled>
                                ...
                                <button class="btn btn-primary" type="button" onclick="window.location
                                        .href='b-Uprofile.php';">Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
