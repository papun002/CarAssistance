                                    ...
                                    <table class="table table-hover table-striped table-vcenter mb-0 text-nowrap"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th onclick="sortTable(1)">C-Code <i class="fa fa-level-up"></i></th>
                                                <th onclick="sortTable(2)">Service Description <i
                                                        class="fa fa-level-up"></i></th>
                                                <th onclick="sortTable(3)">Locality <i class="fa fa-level-up"></i></th>
                                                <th onclick="sortTable(4)">Mobile <i class="fa fa-level-up"></i></th>
                                                <th onclick="sortTable(5)">Feedback <i class="fa fa-level-up"></i></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>Samim Anasari</span></td>
                                                <td><span>MECH77854</span></td>
                                                <td><span>Tyre and Reparing</span></td>
                                                <td><span>Phagwara</span></td>
                                                <td>885663555</td>
                                                <td><span class="tag tag-success">Bad</span></td>
                                            <tr>
                                                <td>
                                                    <label class="custom-control custom-checkbox">
                                                        <input type="checkbox" class="custom-control-input"
                                                ...
                                                <td><span>Phagwara</span></td>
                                                <td>885663555</td>
                                                <td><span class="tag tag-default">Moderate</span></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <label class="custom-control custom-checkbox">
