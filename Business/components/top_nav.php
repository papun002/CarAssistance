            ...
            <div class="container-fluid">
                <div class="page-header">
                    <div class="left ">
                        ...
                        <h1 class="page-title">OnRoad Vechile Breakdown Assistance (BUSINESS)</h1>                        
                    </div>
                    <div class="right">
                        ...
                        <div class="notification d-flex">
                            ...
                            <div class="dropdown d-flex">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="logout.php"><i class="dropdown-icon fa fa-log-out"></i> Sign out</a>
                                </div>
                            </div>
                        </div>
                    </div>
